...
use App\Http\Controllers\WBS\UserController;
use App\Http\Controllers\WBS\ClientController;
use App\Http\Controllers\WBS\BillingController;
...
Route::middleware('auth')->group(function () {
  ...
  Route::post('/store-client', [ClientController::class, 'saveData'])->name('store-client');
  Route::get('/fetch-client', [ClientController::class, 'fetchClient'])->name('fetch-client');
  Route::put('/update-client/{id}', [ClientController::class, 'updateClient'])->name('update-client');
  Route::get('/edit-client/{id}', [ClientController::class, 'getClient'])->name('edit-User');
  Route::delete('/delete-client/{id}', [ClientController::class, 'destroyclient'])->name('delete-client');
  ...
  Route::patch('/billing/{id}/mark-as-paid', [BillingController::class, 'markAsPaid']);
